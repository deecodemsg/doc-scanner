...
export default class DWTScan extends Component<Props, State> {
  ...
  private handleCheckBoxChange(event: React.ChangeEvent<HTMLInputElement>, checkBoxName: keyof State) {
  ...
  render() {
    ...
    const { IfShowUI, IfFeederEnabled, IfAutoDiscardBlankpages, IfDuplexEnabled, PixelType, Resolution } = this.state;
            ...
            <div id="div_ScanImage" className="divTableStyle">
              <ul id="ulScaneImageHIDE">
                <li>
                  ...
                  <select
                    ...
                    onChange={(e) => dwtUtil.handleDeviceChanged(e.target.value)}
                  />
                </li>
                <li id="divProductDetail">
                  <ul id="divTwainType">
                    ...
                    <li>
                      Pixel Type:
                      <label htmlFor="BW" style={{ marginLeft: '5px' }} className="lblPixelType">
                        <input
                          type="radio"
                          id="BW"
                          checked={PixelType === Dynamsoft.DWT.EnumDWT_PixelType.TWPT_BW.toString()}
                      ...
                      <label htmlFor="Gray" className="lblPixelType">
                        <input
                          type="radio"
                          id="Gray"
                          checked={PixelType === Dynamsoft.DWT.EnumDWT_PixelType.TWPT_GRAY.toString()}
                      ...
                      <label htmlFor="RGB" className="lblPixelType">
                        <input
                          type="radio"
                          id="RGB"
                          checked={PixelType === Dynamsoft.DWT.EnumDWT_PixelType.TWPT_RGB.toString()}
              ...
              <div id="divNoScanners" style={{ visibility: 'hidden' }}>
                <a href="#" className="ClosetblLoadImage">
                  <img className="imgClose" src="http://localhost:3000/assets/Images/Close.png" alt="Close tblLoadImage" />
                </a>
                <img src="http://localhost:3000/assets/Images/Warning.png" alt="Warning" />
                <span className="spanContent">
                  <p className="contentTitle">No TWAIN compatible drivers detected</p>
                  <p className="contentDetail">You can Install a Virtual Scanner:</p>
                  <p className="contentDetail">
                    <a id="samplesource32bit" href="https://download.dynamsoft.com/tool/twainds.win32.installer.2.1.3.msi">
                      32-bit Sample Source
                    </a>
                    <a id="samplesource64bit" style={{ display: 'none' }} href="https://download.dynamsoft.com/tool/twainds.win64.installer.2.1.3.msi">
                      64-bit Sample Source
                    </a>{' '}
                    from <a target="_blank" href="http://www.twain.org" rel="noreferrer">TWG</a>
                  </p>
                </span>
              </div>
            </div>
